...
- The dated cache-stability baseline contained 65 packages and retained the pre-existing hwdb failure. The current graph adds a 66th, Debian-compatible `udev` hwdb package and resolves that failure by generating the vendor database during image construction; current validation results supersede the historical hashes in this paragraph.
...
- LinuxScripts is pinned at commit `d1e85219c8f86ceaa1135312126d02fa4dbee623`; its publisher checksum is enforced as `0b0be18e1164481612aa41ab6300c301b5d1088f86f9f653aed5a516ed50f35c`
