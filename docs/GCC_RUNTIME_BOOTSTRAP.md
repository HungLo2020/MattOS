...
The next major boundary is build-tool self-hosting: Binutils, the GCC compiler suite, Make/build systems, Python, Perl, Rust/rustc/Cargo, Git, development packages, and image/package construction tools. None is part of this runtime-only milestone.
